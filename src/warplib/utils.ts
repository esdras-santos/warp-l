...
export function IntxIntFunction(
  ...
  const signed = retType instanceof IntType && (retType as IntType).signed;
...
export function Comparison(
  ...
  const signed = lhsType instanceof IntType && (lhsType as IntType).signed;
