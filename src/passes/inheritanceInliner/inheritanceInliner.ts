...
import { solveConstructors } from './constructorInheritance.ts';
import { addEventDefinition } from './eventInheritance.ts';
import { addPrivateSuperFunctions } from './functionInheritance.ts';
import { solveLibraryInheritance } from './libraryInheritance.ts';
import { addNonOverriddenModifiers as addNonOverriddenModifiers } from './modifiersInheritance.ts';
import { addStorageVariables } from './storageVariablesInheritance.ts';
import {
  getBaseContracts,
