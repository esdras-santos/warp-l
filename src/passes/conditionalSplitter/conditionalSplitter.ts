...
import { createCallToFunction, fixParameterScopes } from '../../utils/functionGeneration.ts';
import {
  CONDITIONAL_FUNCTION_PREFIX,
  PRE_SPLIT_EXPRESSION_PREFIX,
  TUPLE_VALUE_PREFIX,
} from '../../utils/nameModifiers.ts';
import { createIdentifier } from '../../utils/nodeTemplates.ts';
import { counterGenerator, getContainingFunction, toSingleExpression } from '../../utils/utils.ts';
import { ExpressionSplitter } from '../expressionSplitter.ts';
import {
