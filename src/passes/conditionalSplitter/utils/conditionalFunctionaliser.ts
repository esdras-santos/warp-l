...
import { CONDITIONAL_RETURN_VARIABLE } from '../../../utils/nameModifiers.ts';
import {
  createBlock,
  createIdentifier,
  createParameterList,
...
import { safeGetNodeType, safeGetNodeTypeInCtx } from '../../../utils/nodeTypeProcessing.ts';
import { toSingleExpression, typeNameFromTypeNode } from '../../../utils/utils.ts';
