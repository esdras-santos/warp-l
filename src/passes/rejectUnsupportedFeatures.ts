...
import { isDynamicArray, safeGetNodeType, isValueType } from '../utils/nodeTypeProcessing.ts';
import { isExternalCall, isExternallyVisible } from '../utils/utils.ts';
...
export class RejectUnsupportedFeatures extends ASTMapper {
  ...
  visitFunctionCall(node: FunctionCall, ast: AST): void {
    ...
    if (
      ...
      ['require', 'node:assert'].includes(funcName) &&
