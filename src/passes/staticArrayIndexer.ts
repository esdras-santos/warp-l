...
import { CALLDATA_TO_MEMORY_PREFIX } from '../utils/nameModifiers.ts';
import { createIdentifier } from '../utils/nodeTemplates.ts';
import { safeGetNodeType, specializeType } from '../utils/nodeTypeProcessing.ts';
import { getContainingFunction, typeNameFromTypeNode } from '../utils/utils.ts';
