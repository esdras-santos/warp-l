...
import { createCairoGeneratedFunction, ParameterInfo } from '../utils/functionGeneration.ts';
import { TranspileFailedError } from '../utils/errors.ts';
import { createImport } from '../utils/importFuncGenerator.ts';
import { isDynamicArray, isReferenceType } from '../utils/nodeTypeProcessing.ts';
