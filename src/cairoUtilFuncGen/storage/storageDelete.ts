...
import { CairoFunctionDefinition, CairoGeneratedFunctionDefinition } from '../../ast/cairoNodes/index.ts';
...
import { U128_FROM_FELT, UINT256_ADD, UINT256_EQ, UINT256_SUB } from '../../utils/importPaths.ts';
import { getElementType, isDynamicArray, safeGetNodeType } from '../../utils/nodeTypeProcessing.ts';
import { typeNameFromTypeNode, mapRange, narrowBigIntSafe } from '../../utils/utils.ts';
