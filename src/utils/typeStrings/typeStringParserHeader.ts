...
// @ts-nocheck
import { lt } from 'https://deno.land/x/semver/mod.ts';
;
import { InaccessibleDynamicType } from './ast/inaccessibleDynamicType.ts';
import { ModuleType } from './ast/moduleType.ts';
